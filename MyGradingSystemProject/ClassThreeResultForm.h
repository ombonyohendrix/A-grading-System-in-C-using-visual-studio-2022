...
namespace MyGradingSystemProject {
	...
	/// <summary>
	/// Summary for ClassThreeResultForm
	/// </summary>
	public ref class ClassThreeResultForm : public System::Windows::Forms::Form
	{
	public:
		ClassThreeResultForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(2, 140);
			...
			this->label4->Location = System::Drawing::Point(2, 195);
			...
			this->label5->Location = System::Drawing::Point(2, 251);
			...
			this->label6->Location = System::Drawing::Point(2, 306);
			...
			this->label7->Location = System::Drawing::Point(2, 360);
			...
			// txtStudentID
			// 
			this->txtStudentID->Location = System::Drawing::Point(148, 33);
			this->txtStudentID->Name = L"txtStudentID";
			this->txtStudentID->Size = System::Drawing::Size(113, 40);
			this->txtStudentID->TabIndex = 7;
			// 
			// txtFirstname
			// 
			this->txtFirstname->Location = System::Drawing::Point(148, 88);
			this->txtFirstname->Name = L"txtFirstname";
			this->txtFirstname->Size = System::Drawing::Size(113, 40);
			this->txtFirstname->TabIndex = 8;
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(162, 188);
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(99, 40);
			this->textBox3->TabIndex = 9;
			// 
			// txtTotalScore
			// 
			this->txtTotalScore->Location = System::Drawing::Point(162, 244);
			this->txtTotalScore->Name = L"txtTotalScore";
			this->txtTotalScore->Size = System::Drawing::Size(99, 40);
			this->txtTotalScore->TabIndex = 10;
			// 
			// txtSurname
			// 
			this->txtSurname->Location = System::Drawing::Point(148, 133);
			this->txtSurname->Name = L"txtSurname";
			this->txtSurname->Size = System::Drawing::Size(113, 40);
			this->txtSurname->TabIndex = 11;
			// 
			// txtAverage
			// 
			this->txtAverage->Location = System::Drawing::Point(162, 299);
			this->txtAverage->Name = L"txtAverage";
			this->txtAverage->Size = System::Drawing::Size(99, 40);
			this->txtAverage->TabIndex = 12;
			// 
			// txtRanking
			// 
			this->txtRanking->Location = System::Drawing::Point(162, 353);
			this->txtRanking->Name = L"txtRanking";
			this->txtRanking->Size = System::Drawing::Size(99, 40);
			...
			this->dataGridView1->Location = System::Drawing::Point(8, 418);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(744, 105);
			this->dataGridView1->TabIndex = 14;
			// 
			// label8
			// 
			this->label8->AutoSize = true;
			this->label8->Location = System::Drawing::Point(267, 36);
			...
			this->label9->Location = System::Drawing::Point(273, 100);
			...
			this->label10->Location = System::Drawing::Point(279, 159);
			...
			this->label11->Location = System::Drawing::Point(273, 214);
			...
			this->label12->Location = System::Drawing::Point(279, 263);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(177, 33);
			this->label12->TabIndex = 19;
			this->label12->Text = L"Social Study";
			// 
			// label13
			// 
			this->label13->AutoSize = true;
			this->label13->Location = System::Drawing::Point(285, 344);
			this->label13->Name = L"label13";
			this->label13->Size = System::Drawing::Size(119, 33);
			this->label13->TabIndex = 20;
			this->label13->Text = L"Science";
			// 
			// txtKiswahili
			// 
			this->txtKiswahili->Location = System::Drawing::Point(402, 36);
			this->txtKiswahili->Name = L"txtKiswahili";
			this->txtKiswahili->Size = System::Drawing::Size(100, 40);
			this->txtKiswahili->TabIndex = 21;
			// 
			// txtMath
			// 
			this->txtMath->Location = System::Drawing::Point(402, 93);
			this->txtMath->Name = L"txtMath";
			this->txtMath->Size = System::Drawing::Size(100, 40);
			this->txtMath->TabIndex = 22;
			this->txtMath->TextChanged += gcnew System::EventHandler(this, &ClassThreeResultForm::textBox9_TextChanged);
			// 
			// txtEnglish
			// 
			this->txtEnglish->Location = System::Drawing::Point(402, 152);
			this->txtEnglish->Name = L"txtEnglish";
			this->txtEnglish->Size = System::Drawing::Size(100, 40);
			this->txtEnglish->TabIndex = 23;
			// 
			// txtCRE
			// 
			this->txtCRE->Location = System::Drawing::Point(402, 207);
			...
			// txtSocialStudy
			// 
			this->txtSocialStudy->Location = System::Drawing::Point(462, 263);
			this->txtSocialStudy->Name = L"txtSocialStudy";
			this->txtSocialStudy->Size = System::Drawing::Size(40, 40);
			this->txtSocialStudy->TabIndex = 25;
			// 
			// txtScience
			// 
			this->txtScience->Location = System::Drawing::Point(402, 337);
			this->txtScience->Name = L"txtScience";
			this->txtScience->Size = System::Drawing::Size(100, 40);
			this->txtScience->TabIndex = 26;
			// 
			// groupBox1
			// 
			this->groupBox1->Location = System::Drawing::Point(537, 40);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(200, 299);
			...
			// btnRanking
			// 
			this->btnRanking->Location = System::Drawing::Point(19, 529);
			this->btnRanking->Name = L"btnRanking";
			this->btnRanking->Size = System::Drawing::Size(134, 44);
			...
			// btnReset
			// 
			this->btnReset->Location = System::Drawing::Point(169, 529);
			this->btnReset->Name = L"btnReset";
			this->btnReset->Size = System::Drawing::Size(104, 43);
			...
			// btnDelete
			// 
			this->btnDelete->Location = System::Drawing::Point(279, 529);
			this->btnDelete->Name = L"btnDelete";
			this->btnDelete->Size = System::Drawing::Size(132, 43);
			...
			// btnClear
			// 
			this->btnClear->Location = System::Drawing::Point(413, 529);
			this->btnClear->Name = L"btnClear";
			this->btnClear->Size = System::Drawing::Size(125, 43);
			...
			// btnExit
			// 
			this->btnExit->Location = System::Drawing::Point(561, 529);
			this->btnExit->Name = L"btnExit";
			this->btnExit->Size = System::Drawing::Size(137, 43);
			...
			this->Name = L"ClassThreeResultForm";
			this->Text = L"ClassThreeResultForm";
