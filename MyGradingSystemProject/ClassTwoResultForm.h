...
namespace MyGradingSystemProject {
	...
	/// <summary>
	/// Summary for ClassTwoResultForm
	/// </summary>
	public ref class ClassTwoResultForm : public System::Windows::Forms::Form
	{
	public:
		ClassTwoResultForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(2, 22);
			...
			this->label2->Location = System::Drawing::Point(2, 77);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(146, 33);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Firstname";
			this->label2->Click += gcnew System::EventHandler(this, &ClassTwoResultForm::label2_Click);
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(2, 135);
			...
			this->label4->Location = System::Drawing::Point(2, 214);
			...
			this->label5->Location = System::Drawing::Point(-6, 259);
			...
			this->label6->Location = System::Drawing::Point(2, 325);
			...
			this->label7->Location = System::Drawing::Point(2, 382);
			...
			// txtStudentID
			// 
			this->txtStudentID->Location = System::Drawing::Point(172, 26);
			...
			// txtFirstname
			// 
			this->txtFirstname->Location = System::Drawing::Point(172, 77);
			...
			// txtSurname
			// 
			this->txtSurname->Location = System::Drawing::Point(169, 135);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(169, 211);
			...
			// txtTotalScore
			// 
			this->txtTotalScore->Location = System::Drawing::Point(164, 256);
			this->txtTotalScore->Name = L"txtTotalScore";
			this->txtTotalScore->Size = System::Drawing::Size(100, 40);
			this->txtTotalScore->TabIndex = 11;
			// 
			// txtAverage
			// 
			this->txtAverage->Location = System::Drawing::Point(164, 322);
			...
			this->label8->Location = System::Drawing::Point(281, 29);
			...
			this->label9->Location = System::Drawing::Point(281, 80);
			...
			this->label10->Location = System::Drawing::Point(281, 129);
			...
			this->label11->Location = System::Drawing::Point(281, 188);
			...
			this->label12->Location = System::Drawing::Point(281, 238);
			...
			this->label13->Location = System::Drawing::Point(281, 292);
			...
			// txtKiswahili
			// 
			this->txtKiswahili->Location = System::Drawing::Point(408, 26);
			this->txtKiswahili->Name = L"txtKiswahili";
			this->txtKiswahili->Size = System::Drawing::Size(100, 40);
			this->txtKiswahili->TabIndex = 19;
			// 
			// txtMath
			// 
			this->txtMath->Location = System::Drawing::Point(408, 70);
			...
			// txtEnglish
			// 
			this->txtEnglish->Location = System::Drawing::Point(408, 116);
			...
			// txtCRE
			// 
			this->txtCRE->Location = System::Drawing::Point(408, 181);
			...
			// txtScience
			// 
			this->txtScience->Location = System::Drawing::Point(406, 231);
			this->txtScience->Name = L"txtScience";
			this->txtScience->Size = System::Drawing::Size(100, 40);
			this->txtScience->TabIndex = 23;
			// 
			// txtSocialStudy
			// 
			this->txtSocialStudy->Location = System::Drawing::Point(464, 289);
			this->txtSocialStudy->Name = L"txtSocialStudy";
			this->txtSocialStudy->Size = System::Drawing::Size(44, 40);
			this->txtSocialStudy->TabIndex = 24;
			// 
			// txtRanking
			// 
			this->txtRanking->Location = System::Drawing::Point(164, 379);
			...
			// groupBox1
			// 
			this->groupBox1->Location = System::Drawing::Point(546, 26);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(182, 245);
			...
			this->dataGridView1->Location = System::Drawing::Point(8, 454);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(740, 150);
			...
			// btnRanking
			// 
			this->btnRanking->Location = System::Drawing::Point(12, 610);
			this->btnRanking->Name = L"btnRanking";
			this->btnRanking->Size = System::Drawing::Size(141, 50);
			...
			// btnReset
			// 
			this->btnReset->Location = System::Drawing::Point(164, 610);
			this->btnReset->Name = L"btnReset";
			this->btnReset->Size = System::Drawing::Size(121, 50);
			...
			// btnDelete
			// 
			this->btnDelete->Location = System::Drawing::Point(291, 610);
			this->btnDelete->Name = L"btnDelete";
			this->btnDelete->Size = System::Drawing::Size(120, 50);
			...
			// btnClear
			// 
			this->btnClear->Location = System::Drawing::Point(425, 610);
			this->btnClear->Name = L"btnClear";
			this->btnClear->Size = System::Drawing::Size(128, 50);
			...
			// btnExit
			// 
			this->btnExit->Location = System::Drawing::Point(594, 616);
			this->btnExit->Name = L"btnExit";
			this->btnExit->Size = System::Drawing::Size(134, 44);
			...
			this->Name = L"ClassTwoResultForm";
			this->Text = L"ClassTwoResultForm";
