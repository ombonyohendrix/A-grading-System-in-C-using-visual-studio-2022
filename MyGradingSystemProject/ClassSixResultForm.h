...
namespace MyGradingSystemProject {
	...
	/// <summary>
	/// Summary for ClassSixResultForm
	/// </summary>
	public ref class ClassSixResultForm : public System::Windows::Forms::Form
	{
	public:
		ClassSixResultForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(0, 74);
			...
			this->label3->Location = System::Drawing::Point(0, 125);
			...
			this->label4->Location = System::Drawing::Point(0, 173);
			...
			this->label5->Location = System::Drawing::Point(0, 222);
			...
			this->label6->Location = System::Drawing::Point(0, 272);
			...
			this->label7->Location = System::Drawing::Point(0, 323);
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(14) {
				this->Student_ID,
					this->Firstname, this->Surname, this->Class_Code, this->Total_Score, this->Ranking, this->Average, this->Kiswahili, this->Math,
					this->English, this->Column1, this->CRE, this->Science, this->Social_Study
			});
			this->dataGridView1->Location = System::Drawing::Point(6, 404);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(742, 101);
			this->dataGridView1->TabIndex = 7;
			// 
			// btnRanking
			// 
			this->btnRanking->Location = System::Drawing::Point(13, 532);
			this->btnRanking->Name = L"btnRanking";
			this->btnRanking->Size = System::Drawing::Size(138, 40);
			...
			// btnReset
			// 
			this->btnReset->Location = System::Drawing::Point(165, 532);
			this->btnReset->Name = L"btnReset";
			this->btnReset->Size = System::Drawing::Size(122, 40);
			...
			// btnDelete
			// 
			this->btnDelete->Location = System::Drawing::Point(318, 532);
			this->btnDelete->Name = L"btnDelete";
			this->btnDelete->Size = System::Drawing::Size(124, 40);
			...
			// btnClear
			// 
			this->btnClear->Location = System::Drawing::Point(469, 532);
			this->btnClear->Name = L"btnClear";
			this->btnClear->Size = System::Drawing::Size(122, 40);
			...
			// btnExit
			// 
			this->btnExit->Location = System::Drawing::Point(610, 532);
			this->btnExit->Name = L"btnExit";
			this->btnExit->Size = System::Drawing::Size(127, 40);
			...
			this->label8->Location = System::Drawing::Point(271, 34);
			...
			this->label9->Location = System::Drawing::Point(298, 81);
			...
			this->label10->Location = System::Drawing::Point(296, 125);
			...
			this->label11->Location = System::Drawing::Point(298, 177);
			...
			this->label12->Location = System::Drawing::Point(288, 226);
			...
			this->label13->Location = System::Drawing::Point(249, 291);
			...
			// txtStudentID
			// 
			this->txtStudentID->Location = System::Drawing::Point(165, 31);
			this->txtStudentID->Name = L"txtStudentID";
			this->txtStudentID->Size = System::Drawing::Size(100, 40);
			this->txtStudentID->TabIndex = 19;
			// 
			// txtFirstname
			// 
			this->txtFirstname->Location = System::Drawing::Point(165, 74);
			this->txtFirstname->Name = L"txtFirstname";
			this->txtFirstname->Size = System::Drawing::Size(100, 40);
			this->txtFirstname->TabIndex = 20;
			// 
			// txtSurname
			// 
			this->txtSurname->Location = System::Drawing::Point(165, 125);
			this->txtSurname->Name = L"txtSurname";
			this->txtSurname->Size = System::Drawing::Size(100, 40);
			this->txtSurname->TabIndex = 21;
			// 
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(165, 170);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(165, 223);
			...
			// txtAverage
			// 
			this->txtAverage->Location = System::Drawing::Point(148, 269);
			this->txtAverage->Name = L"txtAverage";
			this->txtAverage->Size = System::Drawing::Size(100, 40);
			this->txtAverage->TabIndex = 24;
			// 
			// txtRanking
			// 
			this->txtRanking->Location = System::Drawing::Point(143, 316);
			this->txtRanking->Name = L"txtRanking";
			this->txtRanking->Size = System::Drawing::Size(100, 40);
			this->txtRanking->TabIndex = 25;
			// 
			// txtKiswahili
			// 
			this->txtKiswahili->Location = System::Drawing::Point(432, 27);
			...
			// txtMath
			// 
			this->txtMath->Location = System::Drawing::Point(432, 74);
			...
			// txtEnglish
			// 
			this->txtEnglish->Location = System::Drawing::Point(432, 118);
			...
			// txtCRE
			// 
			this->txtCRE->Location = System::Drawing::Point(432, 170);
			...
			// txtScience
			// 
			this->txtScience->Location = System::Drawing::Point(432, 219);
			...
			// txtSocialStudy
			// 
			this->txtSocialStudy->Location = System::Drawing::Point(432, 284);
			this->txtSocialStudy->Name = L"txtSocialStudy";
			this->txtSocialStudy->Size = System::Drawing::Size(100, 40);
			this->txtSocialStudy->TabIndex = 31;
			// 
			// groupBox1
			// 
			this->groupBox1->Location = System::Drawing::Point(547, 24);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(180, 311);
			...
			this->Name = L"ClassSixResultForm";
			this->Text = L"ClassSixResultForm";
